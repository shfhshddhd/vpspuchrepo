# ==============================================================================
#  🎭 FLEX FUCKER USERBOT - Auto Profile Tools
#  Copyright (C) 2025 by FLEX FUCKER USERBOT.
#  All rights reserved.
# ==============================================================================
...
USER_BG_URL = "https://raw.githubusercontent.com/rishabhops/FLEX FUCKER USERBOT/elite/images/1000083995.jpg"
...
async def loop_autoname(client):
    while RUNNING_TASKS["autoname"]:
        try:
            ist_now = get_ist_time()
            time_str = ist_now.strftime("%H:%M")
            new_name = f"⚡ {time_str} | FLEX FUCKER USERBOT"
...
async def register_commands():
    ...
    async def enable_autobio(event):
        bio_text = event.pattern_match.group(1) or "FLEX FUCKER USERBOT"
